...
- [Example voice file](examples/DOPPELGANGER.md)
- Site: [https://doppelganger.md](https://doppelganger.md)

Instant Start: **Download example** and **Copy starter prompt**.
...
Static site in `docs/`. Host it anywhere.
